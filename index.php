                ...
                <div class="blog-container" > <?php  the_post_thumbnail( 'blog-preview-tumbnail', 'img-responsive' );  ?>
                  <div class="blog-overlay-down">
                    <div class="blog-title">
                      ...
                      <div class="blog-content-meta hidden-sm">  <a href="<?php the_permalink(); ?>"> <?php the_tags(' <i class="fa fa-sitemap"></i><span>Теги:</span>'); ?></a> &nbsp; 
                       ...
                       &nbsp;  <a href="<?php the_permalink(); ?>"> <i class="fa fa-calendar"></i> <?php the_date('d.m.Y'); ?></a> &nbsp; </div>
                    </div>
                  </div>
                </div>
